...
from transformers import BertConfig, BertModel, MBartConfig

from signjoey.helpers import freeze_params
from signjoey.transformer_layers import PositionalEncoding_Hirerachical, mBARTIdentity
from signjoey.transformer_layers import TransformerEncoderLayer_Local
...
class TransformerEncoder(Encoder):
    ...
    def __init__(
        ...
        self.pe = PositionalEncoding_Hirerachical(hidden_size)  
        self.emb_dropout = nn.Dropout(p=emb_dropout)

        self._output_size = hidden_size

        # self.gap = nn.AdaptiveAvgPool1d(1)
        # self.cls_2 = nn.Linear(hidden_size, 30)
    ...
    def forward(
        ...
        # cls_token_2 = x.permute(0, 2, 1).contiguous()
        # cls_token_2 = self.gap(cls_token_2)
        # cls_token_2 = cls_token_2.permute(0, 2, 1).contiguous()
        # cls_token_2 = self.cls_2(cls_token_2)
        # cls_token = torch.add(cls_token, cls_token_2)
